...
#   3. point Vocaret at both via defaults
set -euo pipefail

MODELS_DIR="$HOME/Library/Application Support/Vocaret/Models"
...
defaults write com.jancuhel.vocaret llamaServerPath "$(command -v llama-server)"
defaults write com.jancuhel.vocaret llmModelPath "$MODEL_FILE"
