...
public enum L10n {
    ...
    static let cs: [String: String] = [
        ...
        "Cloud unavailable · Recording continues locally": "Cloud nedostupný · nahrávání pokračuje lokálně",
        "All supported languages": "Všechny podporované jazyky",
        "No language restriction. German and other supported languages are detected automatically.": "Bez omezení jazyků. Němčina i další podporované jazyky se rozpoznávají automaticky.",
        "Only the selected languages are used for detection.": "Rozpoznávání je omezené na vybrané jazyky.",
        "Formatting unavailable · Unformatted dictation saved": "AI úprava nedostupná · uložen neupravený diktát",
        "Formatting failed · Unformatted dictation saved": "AI úprava selhala · uložen neupravený diktát",
